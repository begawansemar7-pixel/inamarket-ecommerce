...
const SellModalResultView: React.FC<SellModalResultViewProps> = ({ description, onDescriptionChange, imagePreview }) => {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="space-y-3">
        <div className="flex justify-between items-center">
          <h3 className="text-lg font-semibold text-gray-800">Deskripsi AI:</h3>
